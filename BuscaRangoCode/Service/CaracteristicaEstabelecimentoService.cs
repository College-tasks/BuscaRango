...
{
    public class CaracteristicaEstabelecimentoService
    {
        /// <summary>
        ...
        public static Retorno Insert(BR_Caracteristica_Estabelecimento obj)
        {
            ...
            using (var ctx = new ER_Entities())
            {
                ...
                {
                    // Adiciona e salva
                    ctx.BR_Caracteristica_Estabelecimento.Add(obj);
                    ctx.SaveChanges();
                }
                catch (Exception ex)
                {
        ...
        /// <returns>Objeto "Retorno" (Sucesso ou falha da operação)</returns>
        public static Retorno Update(BR_Caracteristica_Estabelecimento updateObj, int id)
        {
            // Cria objeto de retorno
            Retorno ret = new Retorno();
            ...
            using (var ctx = new ER_Entities())
            {
                try
                {
                    ...
                    BR_Caracteristica_Estabelecimento obj = ctx.BR_Caracteristica_Estabelecimento.FirstOrDefault(x => x.Id == id);
        ...
        public static Retorno SelectAll()
        {
            ...
            using (var ctx = new ER_Entities())
            {
                try
                {
                    ...
                    var obj = ctx.BR_Caracteristica_Estabelecimento;
        ...
        public static Retorno SelectById(int id)
        {
            ...
            using (var ctx = new ER_Entities())
            {
                try
                {
                    ...
                    var obj = ctx.BR_Caracteristica_Estabelecimento.FirstOrDefault(x => x.Id == id);
                    ret.RetObj = obj;
                }
                catch (Exception ex)
                {
        ...
        public static Retorno Delete(int id)
        {
            ...
            using (var ctx = new ER_Entities())
            {
                try
                {
                    // Recebe o primeiro objeto da lista de Entidades que possui a expressão especificada
                    var obj = ctx.BR_Caracteristica_Estabelecimento.FirstOrDefault(x => x.Id == id);
                    ctx.BR_Caracteristica_Estabelecimento.Remove(obj);
                    ctx.SaveChanges();
                }
                catch (Exception ex)
                {
