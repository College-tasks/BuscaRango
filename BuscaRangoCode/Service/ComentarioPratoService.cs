...
{
    public class ComentarioPratoService
    {
        /// <summary>
        ...
        public static Retorno Insert(BR_Comentario_Prato obj)
        {
            ...
            using (var ctx = new ER_Entities())
            {
                ...
                {
                    // Adiciona e salva
                    ctx.BR_Comentario_Prato.Add(obj);
                    ctx.SaveChanges();
                }
                catch (Exception ex)
                {
        ...
        public static Retorno Update(BR_Comentario_Prato updateObj, int id)
        {
            ...
            using (var ctx = new ER_Entities())
            {
                try
                {
                    ...
                    BR_Comentario_Prato obj = ctx.BR_Comentario_Prato.FirstOrDefault(x => x.Id == id);
        ...
        public static Retorno SelectAll()
        {
            ...
            using (var ctx = new ER_Entities())
            {
                try
                {
                    ...
                    var obj = ctx.BR_Comentario_Prato.Include("BR_Usuario");
        ...
        public static Retorno Delete(int id)
        {
            ...
            using (var ctx = new ER_Entities())
            {
                try
                {
                    ...
                    var obj = ctx.BR_Comentario_Prato.FirstOrDefault(x => x.Id == id);
                    ctx.BR_Comentario_Prato.Remove(obj);
                    ctx.SaveChanges();
                }
                catch (Exception ex)
                {
